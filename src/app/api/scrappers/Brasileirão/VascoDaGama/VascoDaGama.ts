...
// Vasco da Gama official store — Netshoes platform (shopvasco)
// /api/friendly/{category}?page=N returns paginated products
// salePrice is in cents (divide by 100)

const BASE_URL = 'https://www.shopvasco.com.br';
...
export default async function scrapeVasco(): Promise<Product[]> {
