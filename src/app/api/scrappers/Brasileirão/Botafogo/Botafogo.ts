...
// Botafogo official store (VTEX IO)
// Category tree endpoint not available; ft=camisa full-text search is used instead.
const BASE_URL = 'https://store.botafogo.com.br';
const PAGE_SIZE = 50;
...
export default async function scrapeBotafogo(): Promise<Product[]> {
