...
const scrapeChelsea = async function () {
  const url =
    'https://store.chelseafc.com/en/chelsea-football-kits/t-32554035+d-5649214915+z-93-992948644';
  let browser;
  try {
      ...
      products = await page.evaluate((selector) => {
        ...
        document.querySelectorAll(selector).forEach((card) => {
          ...
          if (productUrl && productUrl.startsWith('/')) {
            productUrl = 'https://store.chelseafc.com' + productUrl;
          }
          const currency = 'GBP';
