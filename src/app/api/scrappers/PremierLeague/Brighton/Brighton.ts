...
const scrapeBrighton = async () => {
  const url = 'https://shop.brightonandhovealbion.com/kit/all-kits/';
  let browser;
  try {
    // ...existing code...
      ...
      products = await page.evaluate((selector) => {
        ...
        document.querySelectorAll(selector).forEach((el) => {
          ...
          if (productUrl && productUrl.startsWith('/')) {
            productUrl = 'https://shop.brightonandhovealbion.com' + productUrl;
          }
          const currency = 'GBP';
    ...
    // ...existing code...
    // Save data to output/brighton.json
    // ...existing code...
    await browser.close();
    return products;
  } catch (e) {
