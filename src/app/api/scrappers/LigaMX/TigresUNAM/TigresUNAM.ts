// Tigres UNAM official store (tigretienda.com) — Shopify.
// Uses the Shopify /collections/playera/products.json API.
// Prices are in MXN.

import { Product } from '../../shared/Product';

const BASE_URL = 'https://tigretienda.com';
const COLLECTION_SLUG = 'playera';
...
const scrapeTigresUNAM = async (): Promise<Product[]> => {
  try {
...
export default scrapeTigresUNAM;
