// Atlas FC official store (shop.atlasfc.com.mx) — Shopify.
// Uses the Shopify /collections/jersey/products.json API.
// Prices are in MXN.

import { Product } from '../../shared/Product';

const BASE_URL = 'https://shop.atlasfc.com.mx';
...
const scrapeAtlasFC = async (): Promise<Product[]> => {
  try {
