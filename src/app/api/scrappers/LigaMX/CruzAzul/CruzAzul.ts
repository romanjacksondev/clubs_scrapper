// Cruz Azul official store (tiendacruzazul.mx) — Shopify.
// Uses the Shopify /products.json API for the 'jersey' collection.
// Prices are in MXN.

import { Product } from '../../shared/Product';

const BASE_URL = 'https://www.tiendacruzazul.mx';
const COLLECTION_SLUG = 'jersey';
...
const scrapeCruzAzul = async (): Promise<Product[]> => {
  try {
