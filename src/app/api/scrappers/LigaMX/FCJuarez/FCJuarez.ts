// FC Juárez official store (bravotienda.com) — Shopify.
// Uses the Shopify /collections/jersey-25-26/products.json API for football jerseys.
// Prices are in MXN.

import { Product } from '../../shared/Product';

const BASE_URL = 'https://bravotienda.com';
const COLLECTION_SLUG = 'jersey-25-26';
...
const scrapeFCJuarez = async (): Promise<Product[]> => {
  try {
