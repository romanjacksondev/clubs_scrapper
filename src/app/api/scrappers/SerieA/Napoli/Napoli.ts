// SSC Napoli official store (store.sscnapoli.it) — Shopify.
// Uses the Shopify /products.json API with browser-like headers.
// Kit items are under the ea7-maglie-gara collection (EA7 partnership).

import { Product } from '../../shared/Product';

const BASE_URL = 'https://store.sscnapoli.it';
const COLLECTION_SLUG = 'ea7-maglie-gara';
...
const scrapeNapoli = async (): Promise<Product[]> => {
  try {
