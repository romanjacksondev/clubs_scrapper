// US Lecce official store (www.usleccestore.it) — Shopify.
// Uses the Shopify /products.json API with browser-like headers.

import { Product } from '../../shared/Product';

const BASE_URL = 'https://www.usleccestore.it';
...
const scrapeLecce = async (): Promise<Product[]> => {
  try {
