...
export type ExchangeRateScalarWhereWithAggregatesInput = {
  ...
  rateToUsd?: Prisma.FloatWithAggregatesFilter<"ExchangeRate"> | number
...
export type ExchangeRateUpdateInput = {
  ...
  rateToUsd?: Prisma.FloatFieldUpdateOperationsInput | number
...
export type ExchangeRateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"currency" | "rateToUsd" | "updatedAt", ExtArgs["result"]["exchangeRate"]>
...
export interface ExchangeRateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const exchangeRateWithCurrencyOnly = await prisma.exchangeRate.findMany({ select: { currency: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ExchangeRates and only return the `currency`
   * const exchangeRateWithCurrencyOnly = await prisma.exchangeRate.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ExchangeRates and only return the `currency`
   * const exchangeRateWithCurrencyOnly = await prisma.exchangeRate.updateManyAndReturn({
   *   select: { currency: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ExchangeRateFieldRefs {
  ...
  readonly rateToUsd: Prisma.FieldRef<"ExchangeRate", 'Float'>
